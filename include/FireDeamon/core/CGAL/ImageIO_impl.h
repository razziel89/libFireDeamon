...
//
//
// MODIFICATIONS MADE BY Torsten Sachse TO REMOVE DEPENDENCY ON libGL.so AND libGLU.so
// the original code was left intact by TS but has been commented out. Dependencies on
// CGAL's file type plugins were also removed (i.e., commented out).
