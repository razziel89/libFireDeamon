...
double RadInt::GetRadInt(
    ...
    switch (N){
        ...
        case 2:
            switch (lambda){
                case 0:
                    ...
                    break;
                case 1:
                    result =  0.25*expetaPP*_etaP*_eta
                            - 0.125*erfetaP*_etaPetaP*_sqrteta
        ...
        case 3:
            switch (lambda){
                case 0:
                    result =  0.25*expetaPP*_etaeta
                            + 0.125*erfetaP*_etaP*_eta3half
        ...
        case 4:
            switch (lambda){
                case 0:
                    result =  0.375*sqrtPi*_eta*_eta3half
                            + 0.25*PP*sqrtPi*_eta3half;
                    break;
                case 1:
        ...
        case 5:
            switch (lambda){
                case 0:
                    ...
                    break;
                case 1:
                    result =  0.625*P*sqrtPi*_eta*_eta3half
                            + 0.25*PP*P*sqrtPi*_eta3half;
                    break;
                case 2:
